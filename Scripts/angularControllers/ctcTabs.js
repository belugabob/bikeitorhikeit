angular.module('belugabrain.ctc').controller('CtcTabsCtrl', ['$scope', '$http', function ($scope, $window) {
    ...
    var towns = [
        ...
        ["Stornoway (Western Isles)", 58.208606, -6.379321, 1, 3],
        ...
        ["Giffnock (East Renfrewshire)", 55.804016, -4.293281, 1, 3],
        ...
        ["Irvine (North Ayrshire)", 55.611375, -4.674316, 1, 3],
        ["Motherwell (North Lanarkshire)", 55.791372, -3.993653, 1, 3],
        ["Kirkwall (Orkney Islands)", 58.980809, -2.956504, 1, 3],
        ["Perth (Perth and Kinross)", 56.392139, -3.438886, 1, 3],
        ["Paisley (Renfrewshire)", 55.847063, -4.423750, 1, 3],
        ["Newton St Boswells (Scottish Borders)", 55.577602, -2.673037, 1, 3],
        ["Lerwick (Shetlands)", 60.154283, -1.146738, 1, 3],
        ["Ayr (South Ayrshire)", 55.458149, -4.625201, 1, 3],
        ["Hamilton (South Lanarkshire)", 55.773346, -4.038703, 1, 3],
        ["Stirling (Stirling)", 56.1196735, -3.9359096, 1, 3],
        ["Dumbarton (West Dumbartonshire)", 55.9462834, -4.5683658, 1, 3],
        ["Livingstone (West Lothian)", 55.8718509, -3.5016145, 1, 3]
    ];
